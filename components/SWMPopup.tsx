    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-[550px] overflow-hidden" style={{ pointerEvents: 'auto' }}>
              ...
              <div className="relative" style={{ background: 'linear-gradient(135deg, #FF6B6B 0%, #E04646 100%)' }}>
                ...
                {/* Countdown Timer */}
                <div className="absolute top-4 left-4 flex items-center gap-1.5 bg-white/20 px-2.5 py-1 rounded-full text-xs font-bold text-white">
                  <Clock size={14} />
              ...
              <div className="p-7">
                {/* Yellow Warning Box */}
                <div className="bg-amber-50 border-l-4 border-amber-400 rounded p-3 mb-6 text-left">
                  <strong className="block mb-1 text-sm font-bold text-red-600">⚠️ Compliance Notice</strong>
                ...
                {/* Affected Text */}
                <p className="font-bold text-base text-gray-800 mb-4 text-center">
                ...
                <div className="grid grid-cols-3 gap-3 mb-6">
                  <div className="bg-gray-50 border border-gray-200 rounded-lg p-3 text-center">
                    <div className="text-xl font-extrabold text-gray-800 mb-1">100kg+</div>
                    <div className="text-xs text-gray-600">Waste / day</div>
                  </div>
                  <div className="bg-gray-50 border border-gray-200 rounded-lg p-3 text-center">
                    <div className="text-xl font-extrabold text-gray-800 mb-1">40k L+</div>
                    <div className="text-xs text-gray-600">Water / day</div>
                  </div>
                  <div className="bg-gray-50 border border-gray-200 rounded-lg p-3 text-center">
                    <div className="text-xl font-extrabold text-gray-800 mb-1">20k m²</div>
                    <div className="text-xs text-gray-600">Area</div>
                  </div>
                </div>

                {/* Surge Text */}
                <div className="text-sm text-gray-700 leading-relaxed mb-6 text-center">
                  <span className="text-red-600 font-semibold block mb-1">Demand for composting is surging.</span>
                ...
                <div className="flex gap-3">
                  ...
                  <a
                    href="/contact"
                    onClick={handleClose}
                    className="flex-1 bg-green-600 text-white font-semibold uppercase text-sm py-3.5 rounded-lg hover:bg-green-700 transition-all duration-200 hover:-translate-y-0.5 active:scale-[0.98] text-center shadow-lg shadow-green-600/20"
                  >
                    Talk to Expert
                  </a>
                </div>
